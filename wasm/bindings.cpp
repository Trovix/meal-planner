...
EMSCRIPTEN_KEEPALIVE char* validate_recipe(const char* recipe,const char* ingredients){try{return copy_result(mealplanner::validate_recipe_json(recipe?recipe:"",ingredients?ingredients:""));}catch(const std::exception&e){return copy_result(error_json(e));}}
